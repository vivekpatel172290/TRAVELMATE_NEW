    ...
    <div className="relative min-h-screen bg-[#0a0c10] text-slate-100 overflow-hidden font-sans selection:bg-indigo-500/30 selection:text-indigo-200 py-8 px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="relative group lg:col-span-6">
          ...
          <div className="relative rounded-3xl border-2 border-[#2f323e]/70 bg-gradient-to-br from-[#1c1d24] via-[#14161c] to-[#0c0e12] p-6 sm:p-8 shadow-2xl backdrop-blur-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-black/40 border border-white/10 rounded-xl text-white text-sm focus:outline-none focus:border-indigo-500 transition-all cursor-pointer"
                    >
                      {NATIONALITIES.map((n) => (
                        <option key={n} value={n} className="bg-[#14161f] text-white">
                          {n}
                        </option>
                      ))}
                    </select>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-2.5 bg-black/40 border border-white/10 rounded-xl text-white text-sm focus:outline-none focus:border-indigo-500 transition-all cursor-pointer"
                  >
                    {LANGUAGES.map((l) => (
                      <option key={l.code} value={l.code} className="bg-[#14161f] text-white">
                        {l.label}
                      </option>
                    ))}
                  </select>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-black/40 border border-white/10 rounded-xl text-white placeholder-slate-500 text-sm focus:outline-none focus:border-indigo-500 transition-all"
                  />
                </div>
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-3 px-6 coder-btn-primary text-white font-bold rounded-xl text-sm flex items-center justify-center space-x-2 shadow-lg shadow-indigo-600/30 transition-all duration-200 active:scale-[0.98]"
                >
                  {isGenerating ? (
            ...
            <div className="mt-6 p-4 rounded-xl bg-black/30 border border-white/10 text-xs text-slate-400 space-y-1.5">
        ...
        <div className="relative group lg:col-span-6 flex flex-col justify-between">
          <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-500 rounded-3xl opacity-20 blur-xl group-hover:opacity-30 transition-all duration-700 pointer-events-none" />
          <div className="relative rounded-3xl border-2 border-[#2f323e]/70 bg-gradient-to-br from-[#1c1d24] via-[#14161c] to-[#0c0e12] p-6 sm:p-8 shadow-2xl overflow-hidden flex flex-col justify-between h-full">
            {/* Stamp Ribbon */}
            <div className="absolute -right-12 top-6 bg-gradient-to-r from-[#6b30e3] to-[#8b5cf6] text-white text-[10px] font-black uppercase tracking-widest py-1 px-12 rotate-45 shadow-md">
              VALID DELHI PASS
            </div>
            ...
            <div>
              ...
              {/* Pass QR Visual */}
              <div className="my-6 flex flex-col items-center justify-center p-6 rounded-2xl bg-black/40 border border-white/10">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="p-3 rounded-xl bg-black/40 border border-white/10">
                  ...
                  <p className="text-[11px] text-cyan-400 font-medium">{formData.nationality}</p>
                </div>
                <div className="p-3 rounded-xl bg-black/40 border border-white/10">
                  <span className="text-[10px] uppercase tracking-wider text-slate-400 block mb-1">
                    Validity Window
            ...
            <div className="mt-6 flex items-center justify-between pt-4 border-t border-white/10">
              ...
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-[#6b30e3]/30 to-[#8b5cf6]/30 hover:from-[#6b30e3]/50 hover:to-[#8b5cf6]/50 border border-indigo-500/40 text-indigo-200 hover:text-white rounded-xl text-xs font-bold flex items-center space-x-1.5 transition-all shadow-[0_0_15px_rgba(99,102,241,0.2)]"
              >
